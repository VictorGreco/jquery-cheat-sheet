const load = () => {
    ...
    var CLASS_TO_EVENT = {
        ...
        'vanilla-showKeyPress': ev => clickButtonHandler(ev, showKeyPress),
        'vanilla-mouseMove': ev => clickButtonHandler(ev, mouseMove),
        'vanilla-inputValueChange': ev => clickButtonHandler(ev, inputValueChange),
        'vanilla-isImageLoad': ev => clickButtonHandler(ev, isImageLoad),
        'vanilla-wasFormSmubitted': ev => clickButtonHandler(ev, wasFormSmubitted),
        'vanilla-onSelectChange': ev => clickButtonHandler(ev, onSelectChange),
        'vanilla-isMouseOver': ev => clickButtonHandler(ev, isMouseOver),
        'vanilla-isCheckboxChecked': ev => clickButtonHandler(ev, isCheckboxChecked),
        'vanilla-clickUlListItem': ev => clickButtonHandler(ev, clickUlListItem),
        'vanilla-randomHtmlElementAppender': ev => clickButtonHandler(ev, randomHtmlElementAppender),
        'vanilla-removeElementByTextContent': ev => clickButtonHandler(ev, removeElementByTextContent),
        'vanilla-htmlAbstractAppender': ev => clickButtonHandler(ev, htmlAbstractAppender),
        'vanilla-htmlAbstractPrepender': ev => clickButtonHandler(ev, htmlAbstractPrepender),
        'vanilla-createElementAndAppend': ev => clickButtonHandler(ev, createElementAndAppend),
        'vanilla-createElementAndPrepend': ev => clickButtonHandler(ev, createElementAndPrepend),
        'vanilla-cloneChildNode': ev => clickButtonHandler(ev, cloneChildNode),
        'vanilla-addClass': ev => clickButtonHandler(ev, addClass),
        'vanilla-removeClass': ev => clickButtonHandler(ev, removeClass),
        'vanilla-toggleClass': ev => clickButtonHandler(ev, toggleClass),
        'vanilla-disableElement': ev => clickButtonHandler(ev, disableElement),
        'vanilla-enableElement': ev => clickButtonHandler(ev, enableElement),
        'vanilla-setDataSrc': ev => clickButtonHandler(ev, setDataSrc),
        'vanilla-removeDataSrc': ev => clickButtonHandler(ev, removeDataSrc),
        'vanilla-hideElement': ev => clickButtonHandler(ev, hideElement),
        'vanilla-showElement': ev => clickButtonHandler(ev, showElement),
        'vanilla-fadeIn': ev => clickButtonHandler(ev, fadeIn),
        'vanilla-fadeOut': ev => clickButtonHandler(ev, fadeOut),
        'vanilla-abstractColorator': ev => clickButtonHandler(ev, abstractColorator),
        'vanilla-changeParentFontWeight': ev => clickButtonHandler(ev, changeParentFontWeight),
        'vanilla-changeChildrenFontWeight': ev => clickButtonHandler(ev, changeChildrenFontWeight),
        'vanilla-changeFontWeightById': ev => clickButtonHandler(ev, changeFontWeightById),
        'vanilla-changeFontColorHiddenElementsByClass': ev => clickButtonHandler(ev, changeFontColorHiddenElementsByClass),
        'vanilla-getSelectedOptions': ev => clickButtonHandler(ev, getSelectedOptions),
        'vanilla-changeHrefFirstA': ev => clickButtonHandler(ev, changeHrefFirstA),
        'vanilla-alertFirstInput': ev => clickButtonHandler(ev, alertFirstInput),
        'vanilla-removeItems': ev => clickButtonHandler(ev, removeItems),
